...
class MessageCompiler(object):
    """
    Creates valid messages for the bridge
    ...
    @staticmethod   
    def calculate_implied_volatility(request_id             : int,
                                     contract               : Contract,
                                     option_price           : float,
    ...
    @staticmethod
    def calculate_option_price(request_id               : int,
                               contract                 : Contract,
                               volatility               : float,
                               underlying_price         : float,
                               option_price_options     : list):
        """
        Creates the calculate_option_price bridge message
        ...
        option_price_options_str = ""
        tag_values_count = len(option_price_options) if option_price_options else 0
        if option_price_options:
            for implVolOpt in option_price_options:
                option_price_options_str += str(implVolOpt)
        fields.extend([tag_values_count, option_price_options_str])

        return fields

    @staticmethod
    def cancel_account_summary(request_id: int):
    ...
    @staticmethod
    def cancel_account_updates_multi(request_id: int):
        """
    ...
    @staticmethod
    def cancel_calculate_implied_volatility(request_id: int):
    ...
    @staticmethod
    def cancel_calculate_option_price(request_id: int):
    ...
    @staticmethod
    def cancel_fundamental_data(request_id: int):
        """
    ...
    @staticmethod
    def cancel_market_data(request_id: int):
    ...
    @staticmethod
    def cancel_market_depth(request_id: int, is_smart_depth: bool):
        """
    ...
    def cancel_order(order_id: int):
        """
        Creates a cancel_order message for the bridge application
        :param order_id:
        :return: fields
        """
        message_version = 1
    ...
    @staticmethod
    def cancel_positions_multi(request_id: int):
        """
    ...
    @staticmethod
    def cancel_pnl_single(request_id: int):
    ...
    @staticmethod
    def cancel_scanner_subscription(request_id: int):
    ...
    @staticmethod
    def cancel_tick_by_tick_data(request_id: int):
        message_id = Messages.outbound['cancel_tick_by_tick_data']
        fields = [message_id, request_id]
        return fields

    @staticmethod
    def exercise_options(request_id         : int,
                         contract           : Contract,
                         exercise_or_lapse  : int,
    ...
    @staticmethod
    def place_order(order_id: int, contract: Contract, order: Order):
        """
        ...
        if contract.security_type == "BAG":
            smartComboRoutingParamsCount = len(
                order.smart_combo_routing_params) if order.smart_combo_routing_params else 0
        ...
        if order.order_type == "PEG BENCH":
            fields.extend(
                [order.reference_contract_id, order.is_pegged_change_amount_decrease, order.pegged_change_amount,
            ...
            fields.extend(
                [order.adjusted_order_type, order.trigger_price, order.limit_price_offset, order.adjusted_stop_price,
    ...
    @staticmethod
    def replace_financial_advisor(financial_advisor_data: int, cxml: str):
    ...
    @staticmethod
    def request_account_updates(subscribe: bool, account_code: str):
    ...
    @staticmethod
    def request_account_updates_multi(request_id        : int,
                                      account           : str,
                                      model_code        : str,
                                      ledger_and_nlv    : bool):
    ...
    @staticmethod
    def request_account_summary(request_id  : int,
                                tags        : str,
                                group_name  : str = 'All'):
        """
    ...
    @staticmethod
    def request_auto_open_orders(auto_bind: bool):
        """
        Creates an auto_open_orders message for the bridge application
        :param auto_bind:
        :return:
        """
    ...
    @staticmethod
    def request_contract_data(contract: Contract, request_id):
        """
    ...
    @staticmethod
    def request_executions(request_id: int, client_id="", account_code="", time="",
    ...
    @staticmethod
    def request_head_time_stamp(request_id: int,
                                contract: Contract,
                                what_to_show: str,
                                use_rth: int,
                                format_date: int):
    ...
    @staticmethod
    def request_historical_ticks(request_id: int, contract: Contract, start_date_time: str,
    ...
    @staticmethod
    def request_market_data_type(market_data_type: int):
    ...
    @staticmethod
    def request_market_depth_exchanges():
        """
    ...
    @staticmethod
    def request_market_rule(market_rule_id: int):
        """
    ...
    @staticmethod
    def request_positions_multi(request_id: int, account: str, model_code: str):
        """
    ...
    @staticmethod
    def request_smart_components(request_id: int, bboExchange: str):
    ...
    @staticmethod
    def set_server_log_level(log_level: int):
    ...
    @staticmethod
    def start_api(client_id, optional_capabilities):
        """
        ...
        fields          = [message_id, message_version, client_id, optional_capabilities]
        return fields
    ...
    @staticmethod
    def request_historical_data(request_id      : int,
                                contract        : Contract,
                                end_date_time   : str,
                                duration        : str,
                                bar_size_setting,
        ...
        fields = [message_id, request_id, contract.id, contract.symbol, contract.security_type,
                  ...
                  contract.include_expired, end_date_time, bar_size_setting, duration, use_rth, what_to_show,
                  format_date]
    ...
    @staticmethod    
    def request_news_bulletins(all_messages: bool):
        """
    ...
    @staticmethod    
    def request_pnl(request_id: int, account: str, model_code: str):
    ...
    @staticmethod
    def verify_request(api_name: str, api_version: str):
        """
    ...
    @staticmethod
    def request_market_data(request_id: int,
                            contract: Contract,
    ...
    @staticmethod
    def request_market_depth(request_id: int,
                             contract: Contract,
                             num_rows: int,
                             is_smart_depth: bool,
    ...
    @staticmethod
    def cancel_historical_data(request_id: int):
    ...
    @staticmethod
    def cancel_head_time_stamp(request_id: int):
        """
    ...
    @staticmethod
    def request_scanner_subscription(request_id: int,
                                     scanner: Scanner,
    ...
    @staticmethod
    def request_real_time_bars(request_id: int,
                               contract: Contract,
                               bar_size: int,
                               what_to_show: str,
                               use_rth: bool,
    ...
    @staticmethod
    def request_fundamental_data(request_id     : int, 
                                 contract       : Contract,
                                 report_type    : str, 
    ...
    @staticmethod
    def request_news_article(request_id: int, provider_code: str, articleId: str, news_article_options: list):
    ...
    @staticmethod
    def update_display_group(request_id: int, contract_info: str):
        """
    ...
    @staticmethod
    def unsubscribe_from_group_events(request_id: int):
        """request_id:int - The requestId specified in subscribeToGroupEvents()."""
    ...
    @staticmethod
    def verify_message(api_data: str):
    ...
    @staticmethod
    def verify_and_auth_message(api_data: str, xyzResponse: str):
        """For IB's internal purpose. Allows to provide means of verification
        between the TWS and third party programs."""
