...
class Messages(object):
        ...
        inbound = {
            ...
            'family_codes':78,'symbol_samples':79,'mkt_depth_exchanges':80,'tick_request_params':81,'smart_components':82,
        ...
        outbound = {
            ...
            'request_global_cancel':58,'request_market_data_type':59,'request_positions':61,'request_account_summary':62,'cancel_account_summary':63,
            ...
            'verify_and_auth_message':73,'request_positions_multi':74,'cancel_positions_multi':75,'request_account_updates_multi':76,
            'cancel_account_updates_multi':77,'request_sec_def_opt_params':78,'request_soft_dollar_tiers':79,'request_family_codes':80,
            'request_matching_symbols':81,'request_mkt_depth_exchanges':82,'request_smart_components':83,'request_news_article':84,
            'request_news_providers':85,'request_historical_news':86,'request_head_timestamp':87,'request_histogram_data':88,'cancel_histogram_data':89,
            'cancel_head_timestamp':90,'request_market_rule':91,'request_pnl':92,'cancel_pnl':93,'request_pnl_single':94,'cancel_pnl_single':95,
            'request_historical_ticks':96,'request_tick_by_tick_data':97,'cancel_tick_by_tick_data':98}
